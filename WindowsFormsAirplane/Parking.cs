        ...
        where T : class, ITransport
    {
        ...
        public int CompareTo(Parking<T> other)
        {
            ...
            else if (_places.Count > 0)
            {
                ...
                {
                    if (_places[thisKeys[i]] is Airplane && other._places[thisKeys[i]] is Fighter)
                    {
                        return 1;
                    }
                    if (_places[thisKeys[i]] is Fighter && other._places[thisKeys[i]] is Airplane)
                    {
                        return -1;
                    }
